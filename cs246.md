...
```
- somtimes, the compiler lower to skip copy/move constructors

### Inheritance
>**Note:** Without inheritance, how we store mised of Books and Texts in an array?
>- `union Booktypes{Book *b, Text *t};`
>- cast `Book *b`, `Text *t` to `void *` 

#### initialization
- Derived class cannot access base class's field directly
    - `Test(string author, string topic): Book{author}, topic{topic}{}`
    - protected fields
