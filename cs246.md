...
#### problem 4: copy and move operation
...
public:
    ...
    // making a destructor pure virtual
    //   the class will be abstract even if there are no other pure virtual methods
    // still implement the destructor
};
